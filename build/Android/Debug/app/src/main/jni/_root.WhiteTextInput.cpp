// This file was generated based on 'C:/Users/Brian/Desktop/Workplace/WYT Carpooling 30-1-2018/.uno/ux13/WhiteTextInput.g.uno'.
...
// {
// static WhiteTextInput() :4
static void WhiteTextInput__cctor_3_fn(uType* __type)
{
}

static void WhiteTextInput_build(uType* type)
{
    type->SetInterfaces(
...
::g::Fuse::Controls::TextInputControl_type* WhiteTextInput_typeof()
{
    ...
    options.ObjectSize = sizeof(WhiteTextInput);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextInputControl_type);
    type = (::g::Fuse::Controls::TextInputControl_type*)uClassType::New("WhiteTextInput", options);
    type->fp_build_ = WhiteTextInput_build;
    type->fp_ctor_ = (void*)WhiteTextInput__New4_fn;
    type->fp_cctor_ = WhiteTextInput__cctor_3_fn;
...
// public WhiteTextInput New() :8
void WhiteTextInput__New4_fn(WhiteTextInput** __retval)
{
    *__retval = WhiteTextInput::New4();
}

// public WhiteTextInput() [instance] :8
void WhiteTextInput::ctor_8()
{
    ctor_7();
    InitializeUX();
}
...
void WhiteTextInput::InitializeUX()
{
...
// public WhiteTextInput New() [static] :8
WhiteTextInput* WhiteTextInput::New4()
{
    WhiteTextInput* obj1 = (WhiteTextInput*)uNew(WhiteTextInput_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
