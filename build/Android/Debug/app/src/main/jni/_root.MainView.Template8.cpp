...
{
    MainView__Template8::__selector0_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[0/*"qrcode"*/]);
}

static void MainView__Template8_build(uType* type)
{
    ::STRINGS[0] = uString::Const("qrcode");
    type->SetFields(2,
...
{
    ::g::QRCode* __self1 = ::g::QRCode::New5(uPtr(__this->__parent1)->router);
    __self1->Name(MainView__Template8::__selector0_);
