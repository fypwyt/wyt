...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\UnoCore\1.6.0\Source\Uno\Text\Ascii.uno
// ---------------------------------------------------------------------------------------
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\UnoCore\1.6.0\Source\Uno\Text\Base64.uno
// ----------------------------------------------------------------------------------------
...
uArray* Base64::GetBytes(uString* value)
{
    ...
    for (int32_t position = 0; position < uPtr(value)->Length(); position++)
    {
        ...
        if (addidionalSymbols == 4)
        {
            for (int32_t j = 0; j < 4; j++)
                uPtr(charArray4)->Item<int32_t>(j) = ::g::Uno::String::IndexOf(uPtr<uString*>(::STRINGS[0/*"ABCDEFGHIJK...*/]), (char16_t)uPtr(charArray4)->Item<int32_t>(j), 0);
    ...
    if (addidionalSymbols > 0)
    {
        ...
        for (int32_t j3 = 0; j3 < 4; j3++)
            uPtr(charArray4)->Item<int32_t>(j3) = ::g::Uno::String::IndexOf(uPtr<uString*>(::STRINGS[0/*"ABCDEFGHIJK...*/]), (char16_t)uPtr(charArray4)->Item<int32_t>(j3), 0);
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\UnoCore\1.6.0\Source\Uno\Text\Utf8.uno
// --------------------------------------------------------------------------------------
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\UnoCore\1.6.0\Source\Uno\Text\StringBuilder.uno
// -----------------------------------------------------------------------------------------------
