...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Controls.Panels\1.6.0\Layouts\CircleLayout.uno
// ---------------------------------------------------------------------------------------------------
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Controls.Panels\1.6.0\Layouts\GridLayout.uno
// -------------------------------------------------------------------------------------------------
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Controls.Panels\1.6.0\Layouts\ColumnLayout.uno
// ---------------------------------------------------------------------------------------------------
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Controls.Panels\1.6.0\Layouts\DefaultLayout.uno
// ----------------------------------------------------------------------------------------------------
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Controls.Panels\1.6.0\Layouts\DockLayout.uno
// -------------------------------------------------------------------------------------------------
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Controls.Panels\1.6.0\Layouts\WrapLayout.uno
// -------------------------------------------------------------------------------------------------
...
static void GridLayout_build(uType* type)
{
    ...
    ::TYPES[27] = ::TYPES[26/*Fuse.Layouts.DefinitionBase*/]->MakeMethod(3/*Serialize<Fuse.Layouts.Row>*/, ::g::Fuse::Layouts::Row_typeof(), NULL);
    ::TYPES[28] = ::TYPES[26/*Fuse.Layouts.DefinitionBase*/]->MakeMethod(2/*Parse<Fuse.Layouts.Row>*/, ::g::Fuse::Layouts::Row_typeof(), NULL);
...
{
    return ::g::Fuse::Layouts::DefinitionBase::Serialize1(::TYPES[27/*Fuse.Layouts.DefinitionBase.Serialize<Fuse.Layouts.Row>*/], RowList());
}

// public void set_Rows(string value) [instance] :277
void GridLayout::Rows(uString* value)
{
    ::g::Fuse::Layouts::DefinitionBase::Parse1(::TYPES[28/*Fuse.Layouts.DefinitionBase.Parse<Fuse.Layouts.Row>*/], value, RowList());
    Changed();
}
...
void GridLayout::TrimPad(uType* __type, uObject* list, int32_t count, ::g::Fuse::Layouts::DefinitionBase* primordial)
{
    ...
    {
        if (!uPtr((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(list), __types[2]), uCRef<int32_t>(i), &ret21), ret21))->IsImplied())
            break;
...
int32_t GridLayout::UserCount(uType* __type, uObject* list)
{
    ...
    while ((c > 0) && uPtr((::g::Uno::Collections::IList::get_Item_ex(uInterface(list, __types[1]), uCRef<int32_t>(c - 1), &ret22), ret22))->IsImplied())
        c--;
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Controls.Panels\1.6.0\Layouts\Layout.uno
// ---------------------------------------------------------------------------------------------
...
static void Layout_build(uType* type)
{
    ...
    ::TYPES[4] = ::g::Fuse::Visual_typeof();
    ::TYPES[29] = ::g::Fuse::Elements::Element_typeof();
    type->SetFields(1,
...
bool Layout::ArrangeMarginBoxSpecial(::g::Fuse::Node* n, ::g::Uno::Float4 padding, ::g::Fuse::LayoutParams lp)
{
    ...
    if (lr == 3)
    {
        ::g::Fuse::Elements::Element* elm = uAs< ::g::Fuse::Elements::Element*>(e, ::TYPES[29/*Fuse.Elements.Element*/]);
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Controls.Panels\1.6.0\Layouts\StackLayout.uno
// --------------------------------------------------------------------------------------------------
...
{
    ::TYPES[30] = ::g::Uno::Float4_typeof()->Array();
...
::g::Uno::Float2 WrapLayout::Arrange(::g::Fuse::Visual* container, ::g::Fuse::LayoutParams lp, bool doArrange, ::g::Uno::Float4 padding)
{
    ...
    uArray* placements = uArray::New(::TYPES[30/*float4[]*/], ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(uPtr(container)->Children()), ::TYPES[31/*Uno.Collections.ICollection<Fuse.Node>*/])));
    uArray* minorSizes = uArray::New(::TYPES[2/*float[]*/], ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(container->Children()), ::TYPES[31/*Uno.Collections.ICollection<Fuse.Node>*/])));
    uArray* elementOnRow = uArray::New(::TYPES[32/*int[]*/], ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(container->Children()), ::TYPES[31/*Uno.Collections.ICollection<Fuse.Node>*/])));
    uArray* majorRest = uArray::New(::TYPES[2/*float[]*/], ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(container->Children()), ::TYPES[31/*Uno.Collections.ICollection<Fuse.Node>*/])));
    ...
    for (int32_t j1 = majorStart; j1 < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(container->Children()), ::TYPES[31/*Uno.Collections.ICollection<Fuse.Node>*/])); ++j1)
