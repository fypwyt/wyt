...
#include <Fuse.Drawing.Blitter.h>
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Elements\1.6.0\Enums.uno
// -----------------------------------------------------------------------------
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Elements\1.6.0\Element.Transform.uno
// -----------------------------------------------------------------------------------------
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Elements\1.6.0\AspectBoxSizing.uno
// ---------------------------------------------------------------------------------------
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Elements\1.6.0\BoxSizing.uno
// ---------------------------------------------------------------------------------
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Elements\1.6.0\Caching\Cache.Heuristic.uno
// -----------------------------------------------------------------------------------------------
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Elements\1.6.0\Caching\Cache.uno
// -------------------------------------------------------------------------------------
...
void CacheHelper::Blit(::g::Fuse::DrawContext* dc, ::g::Fuse::Elements::Cache* cache, float opacity)
{
    ...
    for (array1 = uPtr(cache)->CacheTiles(), index2 = 0, length3 = uPtr(array1)->Length(); index2 < length3; ++index2)
    {
        ...
        uPtr(::g::Fuse::Drawing::Blitter::Singleton())->Blit1(tile.Texture(), ::g::Uno::Rect__New2(::g::Uno::Float2__New1(0.0f), size), localToClipTransform, opacity, true, dc->CullFace());
    }
}
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Elements\1.6.0\Caching\ElementAtlasPool.uno
// ------------------------------------------------------------------------------------------------
...
void Element__Draw_fn(Element* __this, ::g::Fuse::DrawContext* dc)
{
    if (!__this->IsRootingCompleted())
        ::g::Fuse::Diagnostics::InternalError(uString::Const("Draw called on a non-rooted node"), __this, uString::Const("C:\\Users\\Brian\\AppData\\Local\\Fusetools\\Packages\\Fuse.Elements\\1.6.0\\Element.Drawing.uno"), 67, uString::Const("Draw"));
...
void Element__OnArrangeMarginBox_fn(Element* __this, ::g::Uno::Float2* position, ::g::Fuse::LayoutParams* lp, ::g::Uno::Float2* __retval)
{
    ...
    if (bp.SanityConstrain())
    {
        if (!Element::_invalidValuesWarn_)
            ::g::Fuse::Diagnostics::InternalError(uString::Const("Invalid values in ArrangeMarginBox"), __this, uString::Const("C:\\Users\\Brian\\AppData\\Local\\Fusetools\\Packages\\Fuse.Elements\\1.6.0\\Element.Layout.uno"), 262, uString::Const("OnArrangeMarginBox"));
...
void Element::Composit(::g::Fuse::DrawContext* dc)
{
    ...
    if (!r && !_warnNoCacheDraw)
    {
        ...
        ::g::Fuse::Diagnostics::InternalError(uString::Const("This element can not be drawn."), this, uString::Const("C:\\Users\\Brian\\AppData\\Local\\Fusetools\\Packages\\Fuse.Elements\\1.6.0\\Element.Effects.uno"), 125, uString::Const("Composit"));
    }
}
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Elements\1.6.0\Caching\ElementAtlas.uno
// --------------------------------------------------------------------------------------------
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Elements\1.6.0\Caching\ElementBatch.uno
// --------------------------------------------------------------------------------------------
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Elements\1.6.0\Caching\ElementBatcher.uno
// ----------------------------------------------------------------------------------------------
...
static void ElementBatcher_build(uType* type)
{
    ...
    ::STRINGS[12] = uString::Const("C:/Users/Brian/AppData/Local/Fusetools/Packages/Fuse.Elements/1.6.0/Caching/ElementBatcher.uno");
        ...
        {
            {
                while (enum4.MoveNext(::TYPES[18/*Uno.Collections.List<Fuse.Visual>.Enumerator*/]))
                {
                    ...
                    if (emitNewBatch || (atlas == NULL))
                    {
                        ...
                        {
                            ::g::Uno::Diagnostics::Debug::Log3(::STRINGS[11/*"BUG: atlas-...*/], 0, ::STRINGS[12/*"C:/Users/Br...*/], 253);
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Elements\1.6.0\Element.Layout.uno
// --------------------------------------------------------------------------------------
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Elements\1.6.0\LayoutFunctions.uno
// ---------------------------------------------------------------------------------------

// public sealed class HeightFunction :110
// {
...
// protected override sealed object GetCurrentValue(Fuse.Elements.Element elm) :120
...
// protected override sealed object GetValue(Fuse.PlacedArgs args) :115
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Elements\1.6.0\Element.HitTest.uno
// ---------------------------------------------------------------------------------------
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Elements\1.6.0\InteractiveTransform.uno
// --------------------------------------------------------------------------------------------
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Elements\1.6.0\Element.ITreeRenderer.uno
// ---------------------------------------------------------------------------------------------
...
// public override sealed Uno.IDisposable Subscribe(Fuse.Reactive.IContext dc, Fuse.Reactive.IListener listener) :15
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Elements\1.6.0\LayoutMasterBoxSizing.uno
// ---------------------------------------------------------------------------------------------
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Elements\1.6.0\LimitBoxSizing.uno
// --------------------------------------------------------------------------------------
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Elements\1.6.0\Transforms.uno
// ----------------------------------------------------------------------------------
...
// private sealed class LayoutFunction.Subscription :23
// {
...
// public Subscription(Fuse.Elements.LayoutFunction lf, Fuse.Reactive.IContext context, Fuse.Reactive.IListener listener) :29
...
// public Subscription New(Fuse.Elements.LayoutFunction lf, Fuse.Reactive.IContext context, Fuse.Reactive.IListener listener) :29
...
// protected override sealed void OnLostData(Fuse.Reactive.IExpression source) :52
...
// private void OnLostMarginBox(object sender, Fuse.LostMarginBoxArgs args) :63
...
// protected override sealed void OnNewData(Fuse.Reactive.IExpression source, object elmObj) :37
...
// private void OnPlaced(object sender, Fuse.PlacedArgs args) :58
...
// private void UnsubscribeElement() :68
void LayoutFunction__Subscription__UnsubscribeElement_fn(LayoutFunction__Subscription* __this)
{
    __this->UnsubscribeElement();
}

// public Subscription(Fuse.Elements.LayoutFunction lf, Fuse.Reactive.IContext context, Fuse.Reactive.IListener listener) [instance] :29
...
// private void OnLostMarginBox(object sender, Fuse.LostMarginBoxArgs args) [instance] :63
...
// private void OnPlaced(object sender, Fuse.PlacedArgs args) [instance] :58
...
// private void UnsubscribeElement() [instance] :68
...
// public Subscription New(Fuse.Elements.LayoutFunction lf, Fuse.Reactive.IContext context, Fuse.Reactive.IListener listener) [static] :29
...
// public sealed class WidthFunction :93
// {
...
// protected override sealed object GetCurrentValue(Fuse.Elements.Element elm) :103
...
// protected override sealed object GetValue(Fuse.PlacedArgs args) :98
...
// public sealed class XFunction :127
// {
...
// protected override sealed object GetCurrentValue(Fuse.Elements.Element elm) :137
...
// protected override sealed object GetValue(Fuse.PlacedArgs args) :132
...
// public sealed class YFunction :144
// {
...
// protected override sealed object GetCurrentValue(Fuse.Elements.Element elm) :154
...
// protected override sealed object GetValue(Fuse.PlacedArgs args) :149
