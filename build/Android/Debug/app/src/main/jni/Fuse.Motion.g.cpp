...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Motion\1.6.0\DelayFunction.uno
// -----------------------------------------------------------------------------------
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Motion\1.6.0\DestinationMotion.uno
// ---------------------------------------------------------------------------------------
...
static void DestinationMotionConfig_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("C:\\Users\\Brian\\AppData\\Local\\Fusetools\\Packages\\Fuse.Motion\\1.6.0\\DestinationMotion.uno");
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Motion\1.6.0\MotionConfig.uno
// ----------------------------------------------------------------------------------
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Motion\1.6.0\Enums.uno
// ---------------------------------------------------------------------------
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Motion\1.6.0\SpringFunction.uno
// ------------------------------------------------------------------------------------
...
static void DelayFunction__Subscription_build(uType* type)
{
    ...
    type->SetInterfaces(
        ::g::Uno::IDisposable_typeof(), offsetof(::g::Fuse::Reactive::ExpressionSubscriber_type, interface0),
        ::g::Fuse::Reactive::IListener_typeof(), offsetof(::g::Fuse::Reactive::ExpressionSubscriber_type, interface1));
    type->SetFields(9);
}

::g::Fuse::Reactive::ExpressionSubscriber_type* DelayFunction__Subscription_typeof()
{
    static uSStrong< ::g::Fuse::Reactive::ExpressionSubscriber_type*> type;
    if (type != NULL) return type;
    ...
    options.TypeSize = sizeof(::g::Fuse::Reactive::ExpressionSubscriber_type);
    type = (::g::Fuse::Reactive::ExpressionSubscriber_type*)uClassType::New("Fuse.Motion.DelayFunction.Subscription", options);
