...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Selection\1.6.0\Selection.uno
// ----------------------------------------------------------------------------------
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Selection\1.6.0\Selectable.ScriptClass.uno
// -----------------------------------------------------------------------------------------------
...
static void Selectable__cctor_1_fn(uType* __type)
{
    ...
    ::g::Fuse::Scripting::ScriptClass::Register(__type, uArray::Init< ::g::Fuse::Scripting::ScriptMember*>(::TYPES[1/*Fuse.Scripting.ScriptMember[]*/], 3, (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New3(::TYPES[2/*Fuse.Scripting.ScriptMethod<Fuse.Selection.Selectable>*/], ::STRINGS[1/*"add"*/], uDelegate::New(::TYPES[3/*Uno.Action<Fuse.Selection.Selectable>*/], (void*)Selectable__add_fn)), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New3(::TYPES[2/*Fuse.Scripting.ScriptMethod<Fuse.Selection.Selectable>*/], ::STRINGS[2/*"remove"*/], uDelegate::New(::TYPES[3/*Uno.Action<Fuse.Selection.Selectable>*/], (void*)Selectable__remove_fn)), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New3(::TYPES[2/*Fuse.Scripting.ScriptMethod<Fuse.Selection.Selectable>*/], ::STRINGS[3/*"toggle"*/], uDelegate::New(::TYPES[3/*Uno.Action<Fuse.Selection.Selectable>*/], (void*)Selectable__toggle_fn))));
}
...
static void Selectable_build(uType* type)
{
    ...
    ::STRINGS[4] = uString::Const("No selection, perhaps not rooted");
    ::STRINGS[5] = uString::Const("C:\\Users\\Brian\\AppData\\Local\\Fusetools\\Packages\\Fuse.Selection\\1.6.0\\Selectable.uno");
    ::STRINGS[6] = uString::Const("Add");
    ::STRINGS[7] = uString::Const("Unable to locate `Selection`");
    ::STRINGS[8] = uString::Const("OnRooted");
    ::STRINGS[9] = uString::Const("Remove");
    ::STRINGS[10] = uString::Const("Toggle");
...
void Selectable__OnRooted_fn(Selectable* __this)
{
    ...
    if (__this->_selection == NULL)
        ::g::Fuse::Diagnostics::UserError(::STRINGS[7/*"Unable to l...*/], __this, ::STRINGS[5/*"C:\\Users\\...*/], 41, ::STRINGS[8/*"OnRooted"*/], NULL);
}
...
void Selectable::Add1()
{
    if (_selection == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[4/*"No selectio...*/], this, ::STRINGS[5/*"C:\\Users\\...*/], 82, ::STRINGS[6/*"Add"*/], NULL);
        return;
    }
...
void Selectable::Remove1()
{
    if (_selection == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[4/*"No selectio...*/], this, ::STRINGS[5/*"C:\\Users\\...*/], 96, ::STRINGS[9/*"Remove"*/], NULL);
        return;
    }
...
void Selectable::Toggle()
{
    if (_selection == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[4/*"No selectio...*/], this, ::STRINGS[5/*"C:\\Users\\...*/], 110, ::STRINGS[10/*"Toggle"*/], NULL);
        return;
    }
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Selection\1.6.0\Selection.ScriptClass.uno
// ----------------------------------------------------------------------------------------------
...
void Selection__FuseReactiveIObserverOnFailed_fn(Selection* __this, uString* message)
{
    ...
    ::g::Fuse::Diagnostics::InternalError(message, __this, uString::Const("C:\\Users\\Brian\\AppData\\Local\\Fusetools\\Packages\\Fuse.Selection\\1.6.0\\Selection.uno"), 495, uString::Const("Fuse.Reactive.IObserver.OnFailed"));
}
...
void Selection__FuseReactiveIObserverOnInsertAt_fn(Selection* __this, int32_t* index, uObject* value)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(uString::Const("removing invalid observable item"), __this, uString::Const("C:\\Users\\Brian\\AppData\\Local\\Fusetools\\Packages\\Fuse.Selection\\1.6.0\\Selection.uno"), 485, uString::Const("Fuse.Reactive.IObserver.OnInsertAt"));
        return;
    }
...
void Selection__FuseReactiveIObserverOnNewAt_fn(Selection* __this, int32_t* index, uObject* newValue)
{
    ...
    if ((index_ < 0) || (index_ >= uPtr(__this->_values)->Count()))
    {
        ::g::Fuse::Diagnostics::InternalError(uString::Const("removing invalid observable item"), __this, uString::Const("C:\\Users\\Brian\\AppData\\Local\\Fusetools\\Packages\\Fuse.Selection\\1.6.0\\Selection.uno"), 450, uString::Const("Fuse.Reactive.IObserver.OnNewAt"));
        return;
    }
...
void Selection__FuseReactiveIObserverOnRemoveAt_fn(Selection* __this, int32_t* index)
{
    ...
    if ((index_ < 0) || (index_ >= uPtr(__this->_values)->Count()))
    {
        ::g::Fuse::Diagnostics::InternalError(uString::Const("removing invalid observable item"), __this, uString::Const("C:\\Users\\Brian\\AppData\\Local\\Fusetools\\Packages\\Fuse.Selection\\1.6.0\\Selection.uno"), 474, uString::Const("Fuse.Reactive.IObserver.OnRemoveAt"));
        return;
    }
...
void Selection::MaxCount(int32_t value)
{
    ...
    if (value < 1)
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("MaxCount must >= 1"), this, uString::Const("C:\\Users\\Brian\\AppData\\Local\\Fusetools\\Packages\\Fuse.Selection\\1.6.0\\Selection.uno"), 138, uString::Const("set_MaxCount"), NULL);
        return;
    }
...
void Selection::OnSelectionChanged(int32_t how)
{
    if ((how == 0) && (_subscription != NULL))
    {
        ...
        if (sub != NULL)
            ...
            ::g::Fuse::Diagnostics::UserWarning(uString::Const("Selection changed, but the bound collection is not writeable."), this, uString::Const("C:\\Users\\Brian\\AppData\\Local\\Fusetools\\Packages\\Fuse.Selection\\1.6.0\\Selection.uno"), 356, uString::Const("OnSelectionChanged"));
    }
...
void Selection::add(Selection* s, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("add requires 1 argument, the value of the item"), s, uString::Const("C:\\Users\\Brian\\AppData\\Local\\Fusetools\\Packages\\Fuse.Selection\\1.6.0\\Selection.ScriptClass.uno"), 43, ::STRINGS[1/*"add"*/], NULL);
        return;
    }
...
void Selection::forceAdd(Selection* s, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("forceAdd requires 1 argument, the value of the item"), s, uString::Const("C:\\Users\\Brian\\AppData\\Local\\Fusetools\\Packages\\Fuse.Selection\\1.6.0\\Selection.ScriptClass.uno"), 75, uString::Const("forceAdd"), NULL);
        return;
    }
...
void Selection::forceRemove(Selection* s, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("forceRemove requires 1 argument, the value of the item"), s, uString::Const("C:\\Users\\Brian\\AppData\\Local\\Fusetools\\Packages\\Fuse.Selection\\1.6.0\\Selection.ScriptClass.uno"), 89, uString::Const("forceRemove"), NULL);
        return;
    }
...
void Selection::remove(Selection* s, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("remove requires 1 argument, the value of the item"), s, uString::Const("C:\\Users\\Brian\\AppData\\Local\\Fusetools\\Packages\\Fuse.Selection\\1.6.0\\Selection.ScriptClass.uno"), 61, ::STRINGS[2/*"remove"*/], NULL);
        return;
    }
...
void Selection::toggle(Selection* s, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("toggle requires 1 argument, the value of them item"), s, uString::Const("C:\\Users\\Brian\\AppData\\Local\\Fusetools\\Packages\\Fuse.Selection\\1.6.0\\Selection.ScriptClass.uno"), 105, ::STRINGS[3/*"toggle"*/], NULL);
        return;
    }
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Selection\1.6.0\ToggleSelection.uno
// ----------------------------------------------------------------------------------------
...
{
    ::STRINGS[11] = uString::Const("Unable to locate Selectable");
    ::STRINGS[12] = uString::Const("C:\\Users\\Brian\\AppData\\Local\\Fusetools\\Packages\\Fuse.Selection\\1.6.0\\ToggleSelection.uno");
    ::STRINGS[13] = uString::Const("Perform");
    type->SetDependencies(
        ::g::Fuse::Selection::Selection_typeof());
    type->SetFields(8,
...
void ToggleSelection__Perform_fn(ToggleSelection* __this, ::g::Fuse::Node* target)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[11/*"Unable to l...*/], __this, ::STRINGS[12/*"C:\\Users\\...*/], 46, ::STRINGS[13/*"Perform"*/], NULL);
        return;
    }
