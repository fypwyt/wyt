...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Gestures\1.6.0\Clicked.uno
// -------------------------------------------------------------------------------
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Gestures\1.6.0\Internal\Clicker.uno
// ----------------------------------------------------------------------------------------
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Gestures\1.6.0\Internal\Helpers.uno
// ----------------------------------------------------------------------------------------
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Gestures\1.6.0\WhileEdgeSwiped.uno
// ---------------------------------------------------------------------------------------
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Gestures\1.6.0\KeepInView.uno
// ----------------------------------------------------------------------------------
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Controls.ScrollView\1.6.0\Scroller.uno
// -------------------------------------------------------------------------------------------
...
{
    _delayStart = value;
    ::g::Fuse::Diagnostics::Deprecated(uString::Const("Scroller.DelayStart is no longer supported."), this, uString::Const("C:\\Users\\Brian\\AppData\\Local\\Fusetools\\Packages\\Fuse.Controls.ScrollView\\1.6.0\\Scroller.uno"), 49, uString::Const("set_DelayStart"));
}
...
void Scroller::OnUpdated()
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(uString::Const("Invalid scroller update"), NULL, uString::Const("C:\\Users\\Brian\\AppData\\Local\\Fusetools\\Packages\\Fuse.Controls.ScrollView\\1.6.0\\Scroller.uno"), 384, uString::Const("OnUpdated"));
        return;
    }
...
void Scroller::UpdatePointerEvents(bool forceOff)
{
    ...
    {
        if (_gesture != NULL)
            ::g::Fuse::Diagnostics::InternalError(uString::Const("inconsistent gesture state"), NULL, uString::Const("C:\\Users\\Brian\\AppData\\Local\\Fusetools\\Packages\\Fuse.Controls.ScrollView\\1.6.0\\Scroller.uno"), 129, uString::Const("UpdatePointerEvents"));
        else
    ...
    {
        if (_gesture == NULL)
            ::g::Fuse::Diagnostics::InternalError(uString::Const("inconsistent gesture state"), NULL, uString::Const("C:\\Users\\Brian\\AppData\\Local\\Fusetools\\Packages\\Fuse.Controls.ScrollView\\1.6.0\\Scroller.uno"), 136, uString::Const("UpdatePointerEvents"));
        else
        {
            uPtr(_gesture)->Dispose();
            _gesture = NULL;
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Controls.ScrollView\1.6.0\Scroller.Actions.uno
// ---------------------------------------------------------------------------------------------------
...
static void ScrollTo_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("C:\\Users\\Brian\\AppData\\Local\\Fusetools\\Packages\\Fuse.Controls.ScrollView\\1.6.0\\Scroller.Actions.uno");
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Gestures\1.6.0\Swipe.uno
// -----------------------------------------------------------------------------
...
static void SwipeGesture_build(uType* type)
{
    ...
    ::STRINGS[6] = uString::Const("C:\\Users\\Brian\\AppData\\Local\\Fusetools\\Packages\\Fuse.Gestures\\1.6.0\\Swipe.uno");
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Gestures\1.6.0\Tapped.uno
// ------------------------------------------------------------------------------
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Gestures\1.6.0\Pressed.uno
// -------------------------------------------------------------------------------
