...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Scripting.JavaScript\1.6.0\FuseJS\Http.uno
// -----------------------------------------------------------------------------------------------
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Scripting.JavaScript\1.6.0\FuseJS\Builtins.uno
// ---------------------------------------------------------------------------------------------------
...
void Builtins::ctor_(::g::Fuse::Scripting::Context* context)
{
    ...
    ::g::Fuse::Scripting::Function* setTimout = uCast< ::g::Fuse::Scripting::Function*>(uPtr(context)->Evaluate(::STRINGS[1/*"fuse-builti...*/], uPtr(::g::FuseScriptingJavaScript_bundle::setTimeoutbf1126fc())->ReadAllText()), ::TYPES[2/*Fuse.Scripting.Function*/]);
    ...
    context->Evaluate(::STRINGS[3/*"fuse-builti...*/], uPtr(::g::FuseScriptingJavaScript_bundle::es6promisemin4894b934())->ReadAllText());
    context->Evaluate(::STRINGS[3/*"fuse-builti...*/], ::STRINGS[4/*"ES6Promise....*/]);
    ::g::Fuse::Reactive::FuseJS::DiagnosticsImplModule::New2();
    ::g::Fuse::Scripting::FileModule::New2(::g::Uno::UX::FileSource::op_Implicit(::g::FuseScriptingJavaScript_bundle::Diagnosticsb3aed263()))->EvaluateExports(context, ::STRINGS[5/*"FuseJS/Diag...*/]);
    Observable = uCast< ::g::Fuse::Scripting::Function*>(::g::Fuse::Scripting::FileModule::New2(::g::Uno::UX::FileSource::op_Implicit(::g::FuseScriptingJavaScript_bundle::Observable5b5a2b3a()))->EvaluateExports(context, ::STRINGS[6/*"FuseJS/Obse...*/]), ::TYPES[2/*Fuse.Scripting.Function*/]);
    TreeObservable = uCast< ::g::Fuse::Scripting::Function*>(::g::Fuse::Scripting::FileModule::New2(::g::Uno::UX::FileSource::op_Implicit(::g::FuseScriptingJavaScript_bundle::TreeObservable7018db7e()))->EvaluateExports(context, ::STRINGS[7/*"FuseJS/Tree...*/]), ::TYPES[2/*Fuse.Scripting.Function*/]);
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Scripting.JavaScript\1.6.0\FuseJS\Timer.uno
// ------------------------------------------------------------------------------------------------
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Scripting.JavaScript\1.6.0\FuseJS\DiagnosticsImpl.uno
// ----------------------------------------------------------------------------------------------------------
...
static void DiagnosticsImplModule_build(uType* type)
{
    ...
    ::STRINGS[17] = uString::Const("C:\\Users\\Brian\\AppData\\Local\\Fusetools\\Packages\\Fuse.Scripting.JavaScript\\1.6.0\\FuseJS\\DiagnosticsImpl.uno");
...
void HttpHeaders::ParseHeader(uString* headerLine)
{
    ...
    int32_t colon = ::g::Uno::String::IndexOf(uPtr(headerLine), ':', 0);
...
{
    ::g::Fuse::Scripting::IThreadWorker::Invoke(uInterface(uPtr(_worker), ::g::Fuse::Scripting::IThreadWorker_typeof()), uDelegate::New(::g::Uno::Action1_typeof()->MakeType(::g::Fuse::Scripting::Context_typeof(), NULL), (void*)Http__HttpJSDispatcher__ActionClosure__Run_fn, Http__HttpJSDispatcher__ActionClosure::New1(action)));
}
...
uObject* TimerModule::Delete(::g::Fuse::Scripting::Context* context, uArray* args)
{
    ...
    catch (const uThrowable& __t)
    {
        if (uIs(__t.Exception, ::g::Fuse::MarshalException_typeof()))
        {
            ...
            ::g::Fuse::Diagnostics::UserWarning(uString::Const("Timer.delete(): The parameter is not a valid timer handle"), this, uString::Const("C:\\Users\\Brian\\AppData\\Local\\Fusetools\\Packages\\Fuse.Scripting.JavaScript\\1.6.0\\FuseJS\\Timer.uno"), 133, uString::Const("Delete"));
        }
        else         throw __t;
    }
