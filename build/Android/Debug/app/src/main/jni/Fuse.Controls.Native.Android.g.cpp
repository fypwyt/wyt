...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Controls.Native\1.6.0\Android\Button.uno
// ---------------------------------------------------------------------------------------------
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Controls.Native\1.6.0\Android\CanvasViewGroup.uno
// ------------------------------------------------------------------------------------------------------
...
static void CanvasViewGroup_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("C:\\Users\\Brian\\AppData\\Local\\Fusetools\\Packages\\Fuse.Controls.Native\\1.6.0\\Android\\CanvasViewGroup.uno");
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Controls.Native\1.6.0\Android\Circle.uno
// ---------------------------------------------------------------------------------------------
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Controls.Native\1.6.0\Android\Ellipse.uno
// ----------------------------------------------------------------------------------------------
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Controls.Native\1.6.0\Android\TextEdit.uno
// -----------------------------------------------------------------------------------------------
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Controls.Native\1.6.0\Android\GraphicsView.uno
// ---------------------------------------------------------------------------------------------------
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Controls.Native\1.6.0\Android\ImageView.uno
// ------------------------------------------------------------------------------------------------
...
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "SetTint140", "(Ljava/lang/Object;I)V");
        ::g::Java::Object* _uhandle=handle;
        jobject _handle = (_uhandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_uhandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
        int32_t _urgba=rgba;
...
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "UpdateImageTransform1141", "(Ljava/lang/Object;FFFF)V");
        ::g::Java::Object* _uhandle=handle;
        jobject _handle = (_uhandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_uhandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
        float _ux=x;
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Controls.Native\1.6.0\Android\InputDispatch.uno
// ----------------------------------------------------------------------------------------------------
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Controls.Native\1.6.0\Android\LeafView.uno
// -----------------------------------------------------------------------------------------------
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Controls.Native\1.6.0\Android\Rectangle.uno
// ------------------------------------------------------------------------------------------------
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Controls.Native\1.6.0\Android\ScrollView.uno
// -------------------------------------------------------------------------------------------------
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Controls.Native\1.6.0\Android\Shape.uno
// --------------------------------------------------------------------------------------------
...
static void Shape_build(uType* type)
{
    ...
    ::STRINGS[5] = uString::Const("C:\\Users\\Brian\\AppData\\Local\\Fusetools\\Packages\\Fuse.Controls.Native\\1.6.0\\Android\\Shape.uno");
...
{
    int32_t layerCount = ((_fills != NULL) ? uPtr(_fills)->Length() : 0) + ((_strokes != NULL) ? uPtr(_strokes)->Length() : 0);
...
void Shape::SetBrush(::g::Java::Object* shapeDrawable, ::g::Fuse::Drawing::Brush* brush)
{
    ...
    else
    {
        ...
        Shape::SetShapeDrawableColor(shapeDrawable, ::g::Uno::Math::Clamp8((int32_t)(c.X * 255.0f), 0, 255), ::g::Uno::Math::Clamp8((int32_t)(c.Y * 255.0f), 0, 255), ::g::Uno::Math::Clamp8((int32_t)(c.Z * 255.0f), 0, 255), ::g::Uno::Math::Clamp8((int32_t)(c.W * 255.0f), 0, 255), ::g::Uno::Math::Clamp8((int32_t)(opacity * 255.0f), 0, 255));
    }
}
...
void Shape::SetLinearGradient(::g::Java::Object* shapeDrawable, ::g::Fuse::Drawing::LinearGradient* linearGradient)
{
    ...
    for (int32_t i = 0; i < stops->Length(); i++)
    {
        ...
        uPtr(colors)->Item<int32_t>(i) = (int32_t)::g::Uno::Color::ToArgb(uPtr(gradientStop)->Color());
...
::g::Java::Object* Shape::GetLayer(::g::Java::Object* handle, int32_t layer)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
...
::g::Java::Object* Shape::MakeLayerDrawable(::g::Java::Object* handle, int32_t layerCount)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        ...
        ::g::Java::Object* _uhandle=handle;
        jobject _handle = (_uhandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_uhandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
        int32_t _ulayerCount=layerCount;
...
int32_t Shape::SelectOffset(::g::Fuse::Drawing::GradientStop* a, ::g::Fuse::Drawing::GradientStop* b)
{
    return (int32_t)::g::Uno::Math::Sign1(uPtr(a)->Offset() - uPtr(b)->Offset());
}

// private static void SetShapeDrawableColor(Java.Object shapeDrawable, int r, int g, int b, int a, int opacity) [static] :162
void Shape::SetShapeDrawableColor(::g::Java::Object* shapeDrawable, int32_t r, int32_t g, int32_t b, int32_t a, int32_t opacity)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Controls.Native\1.6.0\Android\Slider.uno
// ---------------------------------------------------------------------------------------------
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Controls.Native\1.6.0\Android\SurfaceView.uno
// --------------------------------------------------------------------------------------------------
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Controls.Native\1.6.0\Android\Switch.uno
// ---------------------------------------------------------------------------------------------
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Controls.Native\1.6.0\Android\TextureView.uno
// --------------------------------------------------------------------------------------------------
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Controls.Native\1.6.0\Android\TextView.uno
// -----------------------------------------------------------------------------------------------
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Controls.Native\1.6.0\Android\TypefaceCache.uno
// ----------------------------------------------------------------------------------------------------
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Controls.Native\1.6.0\Android\View.uno
// -------------------------------------------------------------------------------------------
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Controls.Native\1.6.0\Android\ViewGroup.uno
// ------------------------------------------------------------------------------------------------
