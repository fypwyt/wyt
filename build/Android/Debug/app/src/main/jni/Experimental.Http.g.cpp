...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Experimental.Http\1.6.0\BinaryLoader.uno
// ----------------------------------------------------------------------------------------
...
::g::Uno::Collections::Dictionary* BinaryLoader::ExtractHeaders(uString* headers)
{
    ...
    for (array1 = ::g::Uno::String::Split(uPtr(headers), uArray::Init<int32_t>(::TYPES[1/*char[]*/], 1, 10)), index2 = 0, length3 = uPtr(array1)->Length(); index2 < length3; ++index2)
    {
        ...
        if (!::g::Uno::String::IsNullOrEmpty(::g::Uno::String::Trim(uPtr(header))))
        {
            ...
            uString* actualValue = (uPtr(arr)->Length() > 1) ? (uString*)::g::Uno::String::Trim(uPtr(::g::Uno::String::Substring(header, ::g::Uno::String::IndexOf1(header, ::STRINGS[0/*":"*/], 0) + 1))) : (uString*)::g::Uno::String::Empty();
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Experimental.Http\1.6.0\HttpLoader.uno
// --------------------------------------------------------------------------------------
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Experimental.Http\1.6.0\HttpResponseHeader.uno
// ----------------------------------------------------------------------------------------------
