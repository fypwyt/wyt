...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\UnoCore\1.6.0\Source\Uno\Runtime\Implementation\Internal\ArrayEnumerable.uno
// ----------------------------------------------------------------------------------------------------------------------------
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\UnoCore\1.6.0\Source\Uno\Runtime\Implementation\Internal\BufferConverters.uno
// -----------------------------------------------------------------------------------------------------------------------------
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\UnoCore\1.6.0\Source\Uno\Runtime\Implementation\Internal\NumericFormatter.uno
// -----------------------------------------------------------------------------------------------------------------------------
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\UnoCore\1.6.0\Source\Uno\Runtime\Implementation\Internal\FormatStringItem.uno
// -----------------------------------------------------------------------------------------------------------------------------
...
{
    int32_t colon = ::g::Uno::String::IndexOf(uPtr(Lexeme()), ':', 0);

    if (colon == -1)
        return NULL;

    int32_t end = ::g::Uno::String::IndexOf(uPtr(Lexeme()), '}', 0);
...
{
    int32_t index = ::g::Uno::String::IndexOf(uPtr(Lexeme()), ',', 0);
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\UnoCore\1.6.0\Source\Uno\Runtime\Implementation\Internal\FormatStringLiteral.uno
// --------------------------------------------------------------------------------------------------------------------------------
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\UnoCore\1.6.0\Source\Uno\Runtime\Implementation\Internal\FormatStringToken.uno
// ------------------------------------------------------------------------------------------------------------------------------
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\UnoCore\1.6.0\Source\Uno\Runtime\Implementation\Internal\FormatStringTokenizer.uno
// ----------------------------------------------------------------------------------------------------------------------------------
...
uString* NumericFormatter::FormatCustom(uString* formatString, double value)
{
    ...
    int32_t decimalPoint = ::g::Uno::String::IndexOf(uPtr(formatString), '.', 0);
...
uString* NumericFormatter::FormatCustomDoublePart(uString* doubleFormat, double d, bool* decimalPoint)
{
    ...
    int32_t index = ::g::Uno::String::IndexOf1(uPtr(raw), NumericFormatter::DecimalPoint(), 0) + 1;
