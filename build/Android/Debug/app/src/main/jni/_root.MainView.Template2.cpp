...
{
    MainView__Template2::__selector0_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[0/*"registerpage"*/]);
}

static void MainView__Template2_build(uType* type)
{
    ::STRINGS[0] = uString::Const("registerpage");
    type->SetFields(2,
...
{
    ::g::RegisterPage* __self1 = ::g::RegisterPage::New5(uPtr(__this->__parent1)->router);
...
{
    ctor_(::STRINGS[0/*"registerpage"*/], false);
    __parent1 = parent;
