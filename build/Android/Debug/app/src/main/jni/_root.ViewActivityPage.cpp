...
#include <_root.ViewActivityPage.h>
...
// {
// static ViewActivityPage() :12
static void ViewActivityPage__cctor_4_fn(uType* __type)
{
    ViewActivityPage::__g_static_nametable1_ = uArray::Init<uString*>(::TYPES[0/*string[]*/], 2, ::STRINGS[0/*"router"*/], ::STRINGS[1/*"temp_eb17"*/]);
    ViewActivityPage::__selector0_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[2/*"Value"*/]);
}

static void ViewActivityPage_build(uType* type)
{
    ...
    ::STRINGS[5] = uString::Const("Pages/ViewActivityPage.ux");
    ::STRINGS[6] = uString::Const("View Activity Page");
    ...
    type->SetFields(118,
        ::g::Fuse::Navigation::Router_typeof(), offsetof(ViewActivityPage, router), 0,
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::String_typeof(), NULL), offsetof(ViewActivityPage, temp_Value_inst), 0,
        ::g::Fuse::Reactive::EventBinding_typeof(), offsetof(ViewActivityPage, temp_eb17), 0,
        ::g::Uno::UX::NameTable_typeof(), offsetof(ViewActivityPage, __g_nametable1), 0,
        ::TYPES[0/*string[]*/], (uintptr_t)&ViewActivityPage::__g_static_nametable1_, uFieldFlagsStatic,
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&ViewActivityPage::__selector0_, uFieldFlagsStatic);
}
...
::g::Fuse::Controls::Panel_type* ViewActivityPage_typeof()
{
    ...
    options.ObjectSize = sizeof(ViewActivityPage);
    options.TypeSize = sizeof(::g::Fuse::Controls::Panel_type);
    type = (::g::Fuse::Controls::Panel_type*)uClassType::New("ViewActivityPage", options);
    type->fp_build_ = ViewActivityPage_build;
    type->fp_cctor_ = ViewActivityPage__cctor_4_fn;
...
// public ViewActivityPage(Fuse.Navigation.Router router) :16
...
// public ViewActivityPage New(Fuse.Navigation.Router router) :16
void ViewActivityPage__New5_fn(::g::Fuse::Navigation::Router* router1, ViewActivityPage** __retval)
{
    *__retval = ViewActivityPage::New5(router1);
}

uSStrong<uArray*> ViewActivityPage::__g_static_nametable1_;
::g::Uno::UX::Selector ViewActivityPage::__selector0_;

// public ViewActivityPage(Fuse.Navigation.Router router) [instance] :16
void ViewActivityPage::ctor_8(::g::Fuse::Navigation::Router* router1)
{
    ctor_7();
    router = router1;
    InitializeUX();
...
void ViewActivityPage::InitializeUX()
{
    __g_nametable1 = ::g::Uno::UX::NameTable::New1(NULL, ViewActivityPage::__g_static_nametable1_);
    ::g::Fuse::Controls::Text* temp = ::g::Fuse::Controls::Text::New3();
    temp_Value_inst = ::g::LoginPage_FuseControlsTextControl_Value_Property::New1(temp, ViewActivityPage::__selector0_);
    ...
    temp4->LineNumber(4);
    temp4->FileName(::STRINGS[5/*"Pages/ViewA...*/]);
    temp4->File(::g::Uno::UX::BundleFileSource::New1(::g::LoginPage_bundle::ViewActivityPage252a2a0e()));
    ...
    temp9->Value(::STRINGS[6/*"View Activi...*/]);
    temp9->FontSize(50.0f);
    temp10->Text(::STRINGS[7/*"Go Back"*/]);
    ::g::Fuse::Gestures::Clicked::AddHandler(temp10, uDelegate::New(::TYPES[3/*Fuse.Gestures.ClickedHandler*/], (void*)::g::Fuse::Reactive::EventBinding__OnEvent_fn, uPtr(temp_eb17)));
...
// public ViewActivityPage New(Fuse.Navigation.Router router) [static] :16
ViewActivityPage* ViewActivityPage::New5(::g::Fuse::Navigation::Router* router1)
{
    ViewActivityPage* obj1 = (ViewActivityPage*)uNew(ViewActivityPage_typeof());
    obj1->ctor_8(router1);
    return obj1;
}
// }
