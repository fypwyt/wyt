...
{
    MainView__Template5::__selector0_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[0/*"changepassw...*/]);
}

static void MainView__Template5_build(uType* type)
{
    ::STRINGS[0] = uString::Const("changepassword");
    type->SetFields(2,
...
{
    ::g::ChangePassword* __self1 = ::g::ChangePassword::New5(uPtr(__this->__parent1)->router);
...
{
    ctor_(::STRINGS[0/*"changepassw...*/], false);
    __parent1 = parent;
