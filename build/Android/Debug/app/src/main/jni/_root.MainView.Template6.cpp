...
{
    MainView__Template6::__selector0_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[0/*"viewactivit...*/]);
}

static void MainView__Template6_build(uType* type)
{
    ::STRINGS[0] = uString::Const("viewactivitypage");
    type->SetFields(2,
...
{
    ::g::ViewActivityPage* __self1 = ::g::ViewActivityPage::New5(uPtr(__this->__parent1)->router);
...
{
    ctor_(::STRINGS[0/*"viewactivit...*/], false);
    __parent1 = parent;
