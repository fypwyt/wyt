...
// private void InitializeUX() :326
void MainView__InitializeUX_fn(MainView* __this)
{
    __this->InitializeUX();
}

// public MainView New() :322
...
// private void InitializeUX() [instance] :326
void MainView::InitializeUX()
{
    ...
    MainView__Template1* mainpage = MainView__Template1::New2(this, this);
    MainView__Template2* registerpage = MainView__Template2::New2(this, this);
    MainView__Template3* settingpage = MainView__Template3::New2(this, this);
    MainView__Template4* changeprofilepage = MainView__Template4::New2(this, this);
    MainView__Template5* changepassword = MainView__Template5::New2(this, this);
    MainView__Template6* viewactivitypage = MainView__Template6::New2(this, this);
    MainView__Template7* createactivitypage = MainView__Template7::New2(this, this);
    MainView__Template8* qrcode = MainView__Template8::New2(this, this);
    ...
    temp1->DefaultPath(uString::Const("loginpage"));
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp1->Templates()), ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Uno::UX::Template_typeof(), NULL)), loginpage);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp1->Templates()), ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Uno::UX::Template_typeof(), NULL)), mainpage);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp1->Templates()), ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Uno::UX::Template_typeof(), NULL)), registerpage);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp1->Templates()), ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Uno::UX::Template_typeof(), NULL)), settingpage);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp1->Templates()), ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Uno::UX::Template_typeof(), NULL)), changeprofilepage);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp1->Templates()), ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Uno::UX::Template_typeof(), NULL)), changepassword);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp1->Templates()), ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Uno::UX::Template_typeof(), NULL)), viewactivitypage);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp1->Templates()), ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Uno::UX::Template_typeof(), NULL)), createactivitypage);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp1->Templates()), ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Uno::UX::Template_typeof(), NULL)), qrcode);
...
// public MainView New() [static] :322
