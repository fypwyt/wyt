...
{
    MainView__Template4::__selector0_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[0/*"changeprofi...*/]);
}

static void MainView__Template4_build(uType* type)
{
    ::STRINGS[0] = uString::Const("changeprofilepage");
    type->SetFields(2,
...
{
    ::g::ChangeProfilePage* __self1 = ::g::ChangeProfilePage::New5(uPtr(__this->__parent1)->router);
...
{
    ctor_(::STRINGS[0/*"changeprofi...*/], false);
    __parent1 = parent;
