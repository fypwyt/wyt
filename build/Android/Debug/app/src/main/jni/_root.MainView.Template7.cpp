...
{
    MainView__Template7::__selector0_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[0/*"createactiv...*/]);
}

static void MainView__Template7_build(uType* type)
{
    ::STRINGS[0] = uString::Const("createactivitypage");
    type->SetFields(2,
...
{
    ::g::CreateActivityPage* __self1 = ::g::CreateActivityPage::New5(uPtr(__this->__parent1)->router);
    __self1->Name(MainView__Template7::__selector0_);
...
{
    ctor_(::STRINGS[0/*"createactiv...*/], false);
    __parent1 = parent;
