...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Scripting.JavaScript\1.6.0\Observable.uno
// ----------------------------------------------------------------------------------------------
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Scripting.JavaScript\1.6.0\TreeObservable\TreeObservable.uno
// -----------------------------------------------------------------------------------------------------------------
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Scripting.JavaScript\1.6.0\ArrayMirror.uno
// -----------------------------------------------------------------------------------------------
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Scripting.JavaScript\1.6.0\TreeObservable\TreeArray.uno
// ------------------------------------------------------------------------------------------------------------
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Scripting.JavaScript\1.6.0\ClassInstance.uno
// -------------------------------------------------------------------------------------------------
...
{
    uPtr(Object)->CallMethod(context, ::STRINGS[1/*"clear"*/], uArray::Init<uObject*>(::TYPES[15/*object[]*/], 1, uBox<int32_t>(::TYPES[60/*int*/], Origin)));
}
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Scripting.JavaScript\1.6.0\ThreadWorker.uno
// ------------------------------------------------------------------------------------------------
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Scripting.JavaScript\1.6.0\DateTimeConverterHelpers.uno
// ------------------------------------------------------------------------------------------------------------
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Scripting.JavaScript\1.6.0\Context.uno
// -------------------------------------------------------------------------------------------
...
static void JSContext__cctor__fn(uType* __type)
{
    ...
    ::g::Fuse::Scripting::ScriptClass::Register(::TYPES[28/*object*/], uArray::New(::g::Fuse::Scripting::ScriptMember_typeof()->Array(), 0));
}
...
{
    if (context != __this)
        ::g::Fuse::Diagnostics::InternalError(uString::Const("IMirror.Reflect with inconsistent context"), __this, uString::Const("C:\\Users\\Brian\\AppData\\Local\\Fusetools\\Packages\\Fuse.Scripting.JavaScript\\1.6.0\\Context.uno"), 94, uString::Const("Fuse.Scripting.JavaScript.IMirror.Reflect"));
...
uObject* JSContext::CreateMirror(uObject* obj)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserWarning(uString::Const("JavaScript data model contains circular references or is too deep. Some data may not display correctly."), this, uString::Const("C:\\Users\\Brian\\AppData\\Local\\Fusetools\\Packages\\Fuse.Scripting.JavaScript\\1.6.0\\Context.uno"), 103, uString::Const("CreateMirror"));
        return NULL;
    }
    ...
    if (o != NULL)
    {
        if (uPtr(o)->InstanceOf(this, uPtr(FuseJS())->Observable))
            ...
            return uBox(::TYPES[58/*Uno.DateTime*/], ::g::Fuse::Scripting::JavaScript::DateTimeConverterHelpers::ConvertDateToDateTime(this, o));
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Scripting.JavaScript\1.6.0\TreeObservable\TreeObject.uno
// -------------------------------------------------------------------------------------------------------------
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Scripting.JavaScript\1.6.0\ObservableProperty.uno
// ------------------------------------------------------------------------------------------------------
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Scripting.JavaScript\1.6.0\ModuleInstance.uno
// --------------------------------------------------------------------------------------------------
...
static void ModuleInstance_build(uType* type)
{
    ...
    ::TYPES[26] = ::g::Uno::Collections::Dictionary__KeyCollection__Enumerator_typeof()->MakeType(::g::Uno::String_typeof(), uObject_typeof(), NULL);
    ::TYPES[27] = ::g::Uno::Collections::IList_typeof()->MakeType(uObject_typeof(), NULL);
    ::TYPES[8] = ::g::Uno::Action_typeof();
    ...
    type->SetFields(1,
        ...
        ::TYPES[28/*object*/], offsetof(ModuleInstance, _dc), 0,
        ...
        ::TYPES[28/*object*/], (uintptr_t)&ModuleInstance::_resetHookMutex_, uFieldFlagsStatic);
}
...
// private void EvaluateModule(Fuse.Scripting.Context context) :90
...
// private void SetDataContext() :58
...
void ModuleInstance::ctor_1(uObject* worker, ::g::Fuse::Reactive::JavaScript* js)
{
    ...
    for (int32_t i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(uPtr(js)->Dependencies()), ::TYPES[22/*Uno.Collections.ICollection<Fuse.Reactive.JavaScript.Dependency>*/])); i++)
        ::g::Uno::Collections::Dictionary__Add_fn(uPtr(_deps), uPtr((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(uPtr(js)->Dependencies()), ::TYPES[23/*Uno.Collections.IList<Fuse.Reactive.JavaScript.Dependency>*/]), uCRef<int32_t>(i), &ret3), ret3))->Name(), uPtr((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(uPtr(js)->Dependencies()), ::TYPES[23/*Uno.Collections.IList<Fuse.Reactive.JavaScript.Dependency>*/]), uCRef<int32_t>(i), &ret4), ret4))->Value);

    _js = js;
    _worker = worker;
    ::g::Fuse::Scripting::IThreadWorker::Invoke(uInterface(uPtr(_worker), ::TYPES[24/*Fuse.Scripting.IThreadWorker*/]), uDelegate::New(::TYPES[9/*Uno.Action<Fuse.Scripting.Context>*/], (void*)ModuleInstance__Evaluate_fn, this));
}
...
void ModuleInstance::Evaluate(::g::Fuse::Scripting::Context* context)
{
    ...
    ::g::Uno::Collections::Dictionary* deps = (::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[21/*Uno.Collections.Dictionary<string, object>*/]);
...

    {
        ...
        {
            {
                while (enum1.MoveNext(::TYPES[26/*Uno.Collections.Dictionary<string, object>.KeyCollection.Enumerator*/]))
                {
                    uString* key = enum1.Current(::TYPES[26/*Uno.Collections.Dictionary<string, object>.KeyCollection.Enumerator*/]);
                    ::g::Uno::Collections::Dictionary__set_Item_fn(uPtr(deps), key, uPtr(ctx)->Unwrap((::g::Uno::Collections::Dictionary__get_Item_fn(uPtr(_deps), key, &ret6), ret6)));
                }
            }
        }
        ...
        {
            {
                enum1.Dispose(::TYPES[26/*Uno.Collections.Dictionary<string, object>.KeyCollection.Enumerator*/]);
            }
                        throw __t;
    ...
    while (nt != NULL)
    {
        for (int32_t i = 0; i < uPtr(uPtr(nt)->Entries)->Length(); ++i)
            ::g::Uno::Collections::Dictionary__Add_fn(uPtr(deps), uPtr(uPtr(nt)->Entries)->Strong<uString*>(i), uPtr(ctx)->Unwrap((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(uPtr(nt)->Objects()), ::TYPES[27/*Uno.Collections.IList<object>*/]), uCRef<int32_t>(i), &ret7), ret7)));
...
// private void EvaluateModule(Fuse.Scripting.Context context) [instance] :90
...
// internal bool ReflectExports() [instance] :64
bool ModuleInstance::ReflectExports()
{
    if (_moduleResult == NULL)
        return false;

    ::g::Fuse::Scripting::IThreadWorker::Invoke(uInterface(uPtr(_worker), ::TYPES[24/*Fuse.Scripting.IThreadWorker*/]), uDelegate::New(::TYPES[9/*Uno.Action<Fuse.Scripting.Context>*/], (void*)ModuleInstance__ReflectExportsJS_fn, this));
    return true;
}

// private void ReflectExportsJS(Fuse.Scripting.Context context) [instance] :48
void ModuleInstance::ReflectExportsJS(::g::Fuse::Scripting::Context* context)
{
    _dc = uPtr(uCast< ::g::Fuse::Scripting::JavaScript::JSContext*>(context, ::TYPES[25/*Fuse.Scripting.JavaScript.JSContext*/]))->Reflect((_moduleResult == NULL) ? uCast<uObject*>(NULL, ::TYPES[28/*object*/]) : (uObject*)uPtr(_moduleResult)->GetExports(context));
    ::g::Fuse::UpdateManager::PostAction(uDelegate::New(::TYPES[8/*Uno.Action*/], (void*)ModuleInstance__SetDataContext_fn, this));
}

// private void SetDataContext() [instance] :58
...
{
    ::TYPES[29] = ::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable_typeof()->MakeType(uObject_typeof(), NULL);
    ::TYPES[0] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Scripting::JavaScript::Observable__Subscription_typeof(), NULL);
    ::TYPES[1] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Scripting::JavaScript::Observable__Subscription_typeof(), NULL);
    ::TYPES[2] = ::g::Fuse::Reactive::IObserver_typeof();
    type->SetFields(2,
...
void Observable__NewAll__OnPerform_fn(Observable__NewAll* __this, uObject* sub)
{
    ...
    uPtr(__this->Observable())->UnsubscribeValues();
    uPtr(uPtr(__this->Observable())->_values)->Clear();
    uPtr(uPtr(__this->Observable())->_values)->AddRange((uObject*)((::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable*)::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable::New1(::TYPES[29/*Uno.Runtime.Implementation.Internal.ArrayEnumerable<object>*/], uPtr(__this->_newValues)->ItemsReadonly())));
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Scripting.JavaScript\1.6.0\ObjectMirror.uno
// ------------------------------------------------------------------------------------------------
...
static void ObjectMirror_build(uType* type)
{
    ::TYPES[21] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::String_typeof(), uObject_typeof(), NULL);
    ::TYPES[5] = ::g::Fuse::Scripting::JavaScript::IMirror_typeof();
    ::TYPES[30] = ::g::Uno::Collections::Dictionary__Enumerator_typeof()->MakeType(::g::Uno::String_typeof(), uObject_typeof(), NULL);
    ::TYPES[6] = ::g::Fuse::Scripting::ValueMirror_typeof();
    ::TYPES[31] = ::g::Uno::Collections::KeyValuePair_typeof()->MakeType(::g::Uno::String_typeof(), uObject_typeof(), NULL);
    ::TYPES[32] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(6/*ToArray<string>*/, ::g::Uno::String_typeof(), NULL);
    type->SetInterfaces(
...
void ObjectMirror__Unsubscribe_fn(ObjectMirror* __this)
{
...

    {
        ...
        {
            {
                while (enum1.MoveNext(::TYPES[30/*Uno.Collections.Dictionary<string, object>.Enumerator*/]))
                {
                    ::g::Uno::Collections::KeyValuePair<uStrong<uString*>, uStrong<uObject*> > p = enum1.Current(::TYPES[30/*Uno.Collections.Dictionary<string, object>.Enumerator*/]);
                    ::g::Fuse::Scripting::ValueMirror* d = uAs< ::g::Fuse::Scripting::ValueMirror*>(p.Value(::TYPES[31/*Uno.Collections.KeyValuePair<string, object>*/]), ::TYPES[6/*Fuse.Scripting.ValueMirror*/]);
        ...
        {
            {
                enum1.Dispose(::TYPES[30/*Uno.Collections.Dictionary<string, object>.Enumerator*/]);
            }
                        throw __t;
...
{
    return (uArray*)::g::Uno::Collections::EnumerableExtensions::ToArray(::TYPES[32/*Uno.Collections.EnumerableExtensions.ToArray<string>*/], (uObject*)((::g::Uno::Collections::Dictionary__KeyCollection*)uPtr(_props)->Keys()));
}
...
void Observable__Unsubscribe_fn(Observable* __this)
{
    ...
    if (!__this->_isUnsubscribed)
    {
        ...
        ::g::Fuse::Scripting::IThreadWorker::Invoke(uInterface(uPtr(__this->_worker), ::TYPES[24/*Fuse.Scripting.IThreadWorker*/]), uDelegate::New(::TYPES[9/*Uno.Action<Fuse.Scripting.Context>*/], (void*)Observable__RemoveSubscriber_fn, __this));
    }
}
...
{
    ::g::Fuse::Scripting::JavaScript::JSContext* ctx = uCast< ::g::Fuse::Scripting::JavaScript::JSContext*>(context, ::TYPES[25/*Fuse.Scripting.JavaScript.JSContext*/]);
    uString* op = uAs<uString*>(uPtr(args)->Strong<uObject*>(1), ::TYPES[50/*string*/]);
    ...
    if (::g::Uno::String::op_Equality(op, uString::Const("set")))
        ...
        ::g::Fuse::UpdateManager::PostAction(uDelegate::New(::TYPES[8/*Uno.Action*/], (void*)Observable__Operation__Perform_fn, Observable__Failed::New1(this, uAs<uString*>(uPtr(args)->Strong<uObject*>(3), ::TYPES[50/*string*/]))));
    else
...
{
    if (uIs(obj, ::TYPES[60/*int*/]))
        return uUnbox<int32_t>(::TYPES[60/*int*/], obj);
...
void TreeObservable__Operation::Perform2(uObject* dc, int32_t pos)
{
    ...
    ::g::Fuse::Scripting::JavaScript::TreeObject* obj = uAs< ::g::Fuse::Scripting::JavaScript::TreeObject*>(dc, ::TYPES[49/*Fuse.Scripting.JavaScript.TreeObject*/]);
...
static void JSContext__PropertyClosure_build(uType* type)
{
    ...
    ::TYPES[15] = uObject_typeof()->Array();
    ::TYPES[18] = ::g::Fuse::Scripting::Callback_typeof();
    ::TYPES[33] = ::g::Uno::UX::PropertyObject_typeof();
    ::TYPES[25] = ::g::Fuse::Scripting::JavaScript::JSContext_typeof();
    type->SetFields(0,
...
{
    ::g::Uno::UX::PropertyObject* obj = uAs< ::g::Uno::UX::PropertyObject*>(uPtr(context)->Wrap(uPtr(args)->Strong<uObject*>(0)), ::TYPES[33/*Uno.UX.PropertyObject*/]);
...
{
    ::g::Fuse::Scripting::JavaScript::TreeObject* t = uCast< ::g::Fuse::Scripting::JavaScript::TreeObject*>(__this->SubscriptionSubject(), ::TYPES[49/*Fuse.Scripting.JavaScript.TreeObject*/]);
...
void Observable__Subscription__ReplaceAllExclusiveOperation::Perform(::g::Fuse::Scripting::Context* context)
{
    ...
    uPtr(Object)->CallMethod(context, ::STRINGS[31/*"replaceAllW...*/], uArray::Init<uObject*>(::TYPES[15/*object[]*/], 2, (::g::Fuse::Scripting::Array*)uPtr(context)->NewArray(NewValues), uBox<int32_t>(::TYPES[60/*int*/], Origin)));
}
...
static void TreeArray__ArraySubscription__ReplaceAllOperation_build(uType* type)
{
    ...
    type->SetFields(0,
        ...
        ::TYPES[34/*Fuse.IArray*/], offsetof(TreeArray__ArraySubscription__ReplaceAllOperation, _newValues), 0);
}
...
{
    uArray* nv = uArray::New(::TYPES[15/*object[]*/], ::g::Fuse::IArray::Length(uInterface(uPtr(_newValues), ::TYPES[34/*Fuse.IArray*/])));

    for (int32_t i = 0; i < ::g::Fuse::IArray::Length(uInterface(uPtr(_newValues), ::TYPES[34/*Fuse.IArray*/])); ++i)
        uPtr(nv)->Strong<uObject*>(i) = uPtr(context)->Unwrap(::g::Fuse::IArray::Item(uInterface(uPtr(_newValues), ::TYPES[34/*Fuse.IArray*/]), i));
...
{
    ::TYPES[35] = ::g::Uno::Action1_typeof()->MakeType(uObject_typeof(), NULL);
    ::TYPES[36] = ::g::Uno::Type_typeof();
    ::TYPES[37] = type->MakeMethod(0/*IsDefault<bool>*/, ::g::Uno::Bool_typeof(), NULL);
    ::TYPES[38] = type->MakeMethod(0/*IsDefault<int>*/, ::g::Uno::Int_typeof(), NULL);
    ::TYPES[39] = type->MakeMethod(0/*IsDefault<float>*/, ::g::Uno::Float_typeof(), NULL);
    ::TYPES[40] = type->MakeMethod(0/*IsDefault<double>*/, ::g::Uno::Double_typeof(), NULL);
    ::TYPES[41] = type->MakeMethod(0/*IsDefault<float2>*/, ::g::Uno::Float2_typeof(), NULL);
    ::TYPES[42] = type->MakeMethod(0/*IsDefault<float3>*/, ::g::Uno::Float3_typeof(), NULL);
    ::TYPES[43] = type->MakeMethod(0/*IsDefault<float4>*/, ::g::Uno::Float4_typeof(), NULL);
    ::TYPES[44] = type->MakeMethod(0/*IsDefault<Uno.UX.Size>*/, ::g::Uno::UX::Size_typeof(), NULL);
    ::TYPES[45] = type->MakeMethod(0/*IsDefault<Uno.UX.Size2>*/, ::g::Uno::UX::Size2_typeof(), NULL);
    ::TYPES[46] = type->MakeMethod(0/*IsDefault<Uno.UX.Selector>*/, ::g::Uno::UX::Selector_typeof(), NULL);
    ...
    type->SetFields(0,
        ...
        ::TYPES[35/*Uno.Action<object>*/], offsetof(ObservableProperty__ResolveDefaultValueClosure, _pushValueOnJSThread), 0);
}
...
void ObservableProperty__ResolveDefaultValueClosure::ctor_(::g::Fuse::Scripting::JavaScript::ObservableProperty* op, uObject* value)
{
    ...
    _pushValueOnJSThread = uDelegate::New(::TYPES[35/*Uno.Action<object>*/], (void*)::g::Fuse::Scripting::JavaScript::ObservableProperty__PushValueOnJSThread_fn, op);
    _value = value;
}
...
bool ObservableProperty__ResolveDefaultValueClosure::IsDefaultValueForType(uObject* value, uType* t)
{
    ...
    if (::g::Uno::Type::IsEnum(uPtr(t)))
        return uUnbox<int32_t>(::TYPES[60/*int*/], value) == 0;

    return ((((((((ObservableProperty__ResolveDefaultValueClosure::IsDefault(::TYPES[37/*Fuse.Scripting.JavaScript.ObservableProperty.ResolveDefaultValueClosure.IsDefault<bool>*/], value, t) || ObservableProperty__ResolveDefaultValueClosure::IsDefault(::TYPES[38/*Fuse.Scripting.JavaScript.ObservableProperty.ResolveDefaultValueClosure.IsDefault<int>*/], value, t)) || ObservableProperty__ResolveDefaultValueClosure::IsDefault(::TYPES[39/*Fuse.Scripting.JavaScript.ObservableProperty.ResolveDefaultValueClosure.IsDefault<float>*/], value, t)) || ObservableProperty__ResolveDefaultValueClosure::IsDefault(::TYPES[40/*Fuse.Scripting.JavaScript.ObservableProperty.ResolveDefaultValueClosure.IsDefault<double>*/], value, t)) || ObservableProperty__ResolveDefaultValueClosure::IsDefault(::TYPES[41/*Fuse.Scripting.JavaScript.ObservableProperty.ResolveDefaultValueClosure.IsDefault<float2>*/], value, t)) || ObservableProperty__ResolveDefaultValueClosure::IsDefault(::TYPES[42/*Fuse.Scripting.JavaScript.ObservableProperty.ResolveDefaultValueClosure.IsDefault<float3>*/], value, t)) || ObservableProperty__ResolveDefaultValueClosure::IsDefault(::TYPES[43/*Fuse.Scripting.JavaScript.ObservableProperty.ResolveDefaultValueClosure.IsDefault<float4>*/], value, t)) || ObservableProperty__ResolveDefaultValueClosure::IsDefault(::TYPES[44/*Fuse.Scripting.JavaScript.ObservableProperty.ResolveDefaultValueClosure.IsDefault<Uno.UX.Size>*/], value, t)) || ObservableProperty__ResolveDefaultValueClosure::IsDefault(::TYPES[45/*Fuse.Scripting.JavaScript.ObservableProperty.ResolveDefaultValueClosure.IsDefault<Uno.UX.Size2>*/], value, t)) || ObservableProperty__ResolveDefaultValueClosure::IsDefault(::TYPES[46/*Fuse.Scripting.JavaScript.ObservableProperty.ResolveDefaultValueClosure.IsDefault<Uno.UX.Selector>*/], value, t);
}
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Scripting.JavaScript\1.6.0\RootableScriptModule.uno
// --------------------------------------------------------------------------------------------------------
...
// public RootableScriptModule(Fuse.Scripting.JavaScript.ThreadWorker worker, Uno.UX.NameTable names) :16
...
// protected override sealed void CallModuleFunc(Fuse.Scripting.Context context, Fuse.Scripting.Function moduleFunc, object[] args) :57
...
// private void EnsureClassInstanceRooted(Fuse.Scripting.Context c) :28
...
// protected override sealed string GenerateArgs(Fuse.Scripting.Context c, Fuse.Scripting.ModuleResult result, Uno.Collections.List<object> args) :44
        ...
        {
            {
                while (enum1.MoveNext(::TYPES[30/*Uno.Collections.Dictionary<string, object>.Enumerator*/]))
                {
                    ::g::Uno::Collections::KeyValuePair<uStrong<uString*>, uStrong<uObject*> > dep = enum1.Current(::TYPES[30/*Uno.Collections.Dictionary<string, object>.Enumerator*/]);
                    argsString = ::g::Uno::String::op_Addition2(argsString, ::g::Uno::String::op_Addition2(::STRINGS[34/*", "*/], dep.Key(::TYPES[31/*Uno.Collections.KeyValuePair<string, object>*/])));
                    ::g::Uno::Collections::List__Add_fn(uPtr(args), dep.Value(::TYPES[31/*Uno.Collections.KeyValuePair<string, object>*/]));
                }
            }
        }
...
// protected override sealed Uno.Collections.Dictionary<string, object> GenerateRequireTable(Fuse.Scripting.Context c) :39
...
// public RootableScriptModule New(Fuse.Scripting.JavaScript.ThreadWorker worker, Uno.UX.NameTable names) :16
...
// public RootableScriptModule(Fuse.Scripting.JavaScript.ThreadWorker worker, Uno.UX.NameTable names) [instance] :16
...
// private void EnsureClassInstanceRooted(Fuse.Scripting.Context c) [instance] :28
...
// public RootableScriptModule New(Fuse.Scripting.JavaScript.ThreadWorker worker, Uno.UX.NameTable names) [static] :16
...
{
    ::TYPES[47] = ::g::Fuse::Scripting::JavaScript::TreeObject__PropertySubscription_typeof();
    ::TYPES[30] = ::g::Uno::Collections::Dictionary__Enumerator_typeof()->MakeType(::g::Uno::String_typeof(), uObject_typeof(), NULL);
    ::TYPES[31] = ::g::Uno::Collections::KeyValuePair_typeof()->MakeType(::g::Uno::String_typeof(), uObject_typeof(), NULL);
    type->SetFields(0,
...
void TreeObject__SetClosure::Perform()
{
    ...
    ::g::Fuse::Scripting::JavaScript::TreeObject__PropertySubscription* sub = uAs< ::g::Fuse::Scripting::JavaScript::TreeObject__PropertySubscription*>(uPtr(_treeObject)->Subscribers(), ::TYPES[47/*Fuse.Scripting.JavaScript.TreeObject.PropertySubscription*/]);
            ...
            {
                {
                    while (enum1.MoveNext(::TYPES[30/*Uno.Collections.Dictionary<string, object>.Enumerator*/]))
                    {
                        ::g::Uno::Collections::KeyValuePair<uStrong<uString*>, uStrong<uObject*> > prop = enum1.Current(::TYPES[30/*Uno.Collections.Dictionary<string, object>.Enumerator*/]);
                        uPtr(sub)->OnPropertyChanged(prop.Key(::TYPES[31/*Uno.Collections.KeyValuePair<string, object>*/]), prop.Value(::TYPES[31/*Uno.Collections.KeyValuePair<string, object>*/]), NULL);
                    }
                }
            }
...
static void Observable__Subscription__SetExclusiveOperation_build(uType* type)
{
    ...
    ::TYPES[48] = ::g::Fuse::Scripting::ScriptException_typeof();
    ::TYPES[15] = uObject_typeof()->Array();
    type->SetFields(0,
    ...
    {
        {
            ...
            uPtr(Object)->CallMethod(context, ::STRINGS[35/*"setValueWit...*/], uArray::Init<uObject*>(::TYPES[15/*object[]*/], 2, newValue, uBox<int32_t>(::TYPES[60/*int*/], Origin)));
        }
    }

    catch (const uThrowable& __t)
    {
        if (uIs(__t.Exception, ::TYPES[48/*Fuse.Scripting.ScriptException*/]))
        {
...
{
    ::TYPES[49] = ::g::Fuse::Scripting::JavaScript::TreeObject_typeof();
    ::TYPES[3] = ::g::Fuse::Scripting::JavaScript::TreeArray_typeof();
    type->SetDependencies(
        ::g::Fuse::Marshal_typeof());
    type->SetFields(3);
...
{
    uArray* arr = uArray::New(::TYPES[15/*object[]*/], ::g::Fuse::IArray::Length(uInterface(uPtr(newValues), ::TYPES[34/*Fuse.IArray*/])));

    for (int32_t i = 0; i < arr->Length(); i++)
        uPtr(arr)->Strong<uObject*>(i) = ::g::Fuse::IArray::Item(uInterface(uPtr(newValues), ::TYPES[34/*Fuse.IArray*/]), i);
    ...
    ::g::Fuse::Scripting::IThreadWorker::Invoke(uInterface(uPtr(uPtr(__this->_om)->_worker), ::TYPES[24/*Fuse.Scripting.IThreadWorker*/]), uDelegate::New(::TYPES[9/*Uno.Action<Fuse.Scripting.Context>*/], (void*)Observable__Subscription__ReplaceAllExclusiveOperation__Perform_fn, op));
}
...
void Observable__Subscription__FuseReactiveISubscriptionSetExclusive_fn(Observable__Subscription* __this, uObject* newValue)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(uString::Const("Unexpected null object"), __this, uString::Const("C:\\Users\\Brian\\AppData\\Local\\Fusetools\\Packages\\Fuse.Scripting.JavaScript\\1.6.0\\Observable.uno"), 132, uString::Const("Fuse.Reactive.ISubscription.SetExclusive"));
        return;
    }
    ...
    ::g::Fuse::Scripting::IThreadWorker::Invoke(uInterface(uPtr(uPtr(__this->_om)->_worker), ::TYPES[24/*Fuse.Scripting.IThreadWorker*/]), uDelegate::New(::TYPES[9/*Uno.Action<Fuse.Scripting.Context>*/], (void*)Observable__Subscription__SetExclusiveOperation__Perform_fn, op));
}
...
void Observable__Subscription::SetExclusive(::g::Fuse::Scripting::Context* context, uObject* newValue)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(uString::Const("Unexpected null object"), this, uString::Const("C:\\Users\\Brian\\AppData\\Local\\Fusetools\\Packages\\Fuse.Scripting.JavaScript\\1.6.0\\Observable.uno"), 118, uString::Const("SetExclusive"));
        return;
    }
...
ThreadWorker_type* ThreadWorker_typeof()
{
    ...
    type->interface1.fp_Invoke = (void(*)(uObject*, uDelegate*))ThreadWorker__Invoke1_fn;
    return type;
}
...
void ThreadWorker::Run()
{
    ...
    catch (const uThrowable& __t)
    {
        ...
        ::g::Fuse::Diagnostics::UnknownException(uString::Const("ThreadWorked failed"), e, this, uString::Const("C:\\Users\\Brian\\AppData\\Local\\Fusetools\\Packages\\Fuse.Scripting.JavaScript\\1.6.0\\ThreadWorker.uno"), 64, uString::Const("Run"));
        DispatchException(e);
    }
}
...
void TreeArray::ReplaceAll(uObject* newValues, TreeArray__ArraySubscription* exclude)
{
    ...
    for (int32_t i1 = 0; i1 < ::g::Fuse::IArray::Length(uInterface(uPtr(newValues), ::TYPES[34/*Fuse.IArray*/])); ++i1)
        ::g::Uno::Collections::List__Add_fn(uPtr(_items), ::g::Fuse::IArray::Item(uInterface(uPtr(newValues), ::TYPES[34/*Fuse.IArray*/]), i1));
...
void TreeObject::Set1(uString* key, uObject* newValue, TreeObject__PropertySubscription* exclude)
{
    ...
    TreeObject__PropertySubscription* sub = uAs<TreeObject__PropertySubscription*>(Subscribers(), ::TYPES[47/*Fuse.Scripting.JavaScript.TreeObject.PropertySubscription*/]);
...
int64_t TreeObservable::GetId(::g::Fuse::Scripting::Context* context, uObject* obj)
{
    ...
    if (uIs(res, ::TYPES[60/*int*/]))
        return (int64_t)uUnbox<int32_t>(::TYPES[60/*int*/], res);
...
// C:\Users\Brian\AppData\Local\Fusetools\Packages\Fuse.Scripting.JavaScript\1.6.0\TypeWrapper.uno
// -----------------------------------------------------------------------------------------------
...
static void TypeWrapper_build(uType* type)
{
    ...
    ::TYPES[51] = ::g::Fuse::Scripting::IRaw_typeof();
    ::TYPES[16] = ::g::Fuse::Scripting::Function_typeof();
    ::TYPES[11] = ::g::Fuse::Scripting::Object_typeof();
    ::TYPES[20] = ::g::Fuse::Scripting::Array_typeof();
    ...
    ::TYPES[55] = ::g::Uno::Int2_typeof();
    ::TYPES[56] = ::g::Uno::Int3_typeof();
    ::TYPES[57] = ::g::Uno::Int4_typeof();
    ::TYPES[58] = ::g::Uno::DateTime_typeof();
    ::TYPES[19] = ::g::Fuse::Scripting::External_typeof();
    ::TYPES[59] = ::g::Uno::Float_typeof();
    ::TYPES[60] = ::g::Uno::Int_typeof();
    ::TYPES[61] = ::g::Uno::UInt_typeof();
    ::TYPES[62] = ::g::Fuse::Scripting::IScriptObject_typeof();
    type->SetDependencies(
...
uObject* TypeWrapper::Unwrap(::g::Fuse::Scripting::JavaScript::JSContext* context, uObject* dc)
{
    if (dc == NULL)
        return NULL;
    else if (uIs(dc, ::TYPES[50/*string*/]))
        return dc;
    else if (uIs(dc, ::TYPES[51/*Fuse.Scripting.IRaw*/]))
        return ::g::Fuse::Scripting::IRaw::ReflectedRaw(uInterface(uPtr((uObject*)dc), ::TYPES[51/*Fuse.Scripting.IRaw*/]));
        ...
        return dc;
    else if (uIs(dc, ::TYPES[52/*float2*/]))
        return TypeWrapper::ToArray(context, uUnbox< ::g::Uno::Float2>(::TYPES[52/*float2*/], dc));
    else if (uIs(dc, ::TYPES[53/*float3*/]))
        return TypeWrapper::ToArray1(context, uUnbox< ::g::Uno::Float3>(::TYPES[53/*float3*/], dc));
    else if (uIs(dc, ::TYPES[54/*float4*/]))
        return TypeWrapper::ToArray2(context, uUnbox< ::g::Uno::Float4>(::TYPES[54/*float4*/], dc));
    else if (uIs(dc, ::TYPES[55/*int2*/]))
        return TypeWrapper::ToArray3(context, uUnbox< ::g::Uno::Int2>(::TYPES[55/*int2*/], dc));
    else if (uIs(dc, ::TYPES[56/*int3*/]))
        return TypeWrapper::ToArray4(context, uUnbox< ::g::Uno::Int3>(::TYPES[56/*int3*/], dc));
    else if (uIs(dc, ::TYPES[57/*int4*/]))
        return TypeWrapper::ToArray5(context, uUnbox< ::g::Uno::Int4>(::TYPES[57/*int4*/], dc));
    else if (uIs(dc, ::TYPES[58/*Uno.DateTime*/]))
        return ::g::Fuse::Scripting::JavaScript::DateTimeConverterHelpers::ConvertDateTimeToJSDate(context, uUnbox< ::g::Uno::DateTime>(::TYPES[58/*Uno.DateTime*/], dc), uPtr(uPtr(context)->FuseJS())->DateCtor);
...
uObject* TypeWrapper::Wrap(::g::Fuse::Scripting::JavaScript::JSContext* context, uObject* obj)
{
    ...
    else if (uIs(obj, ::TYPES[11/*Fuse.Scripting.Object*/]))
    {
        ...
        if (uPtr(sobj)->InstanceOf(context, uPtr(uPtr(context)->FuseJS())->Date))
            return uBox(::TYPES[58/*Uno.DateTime*/], ::g::Fuse::Scripting::JavaScript::DateTimeConverterHelpers::ConvertDateToDateTime(context, sobj));
    ...
    if (uIs(obj, ::TYPES[59/*float*/]))
        return uBox(::g::Uno::Double_typeof(), (double)uUnbox<float>(::TYPES[59/*float*/], obj));

    if (uIs(obj, ::TYPES[60/*int*/]))
        return uBox(::g::Uno::Double_typeof(), (double)uUnbox<int32_t>(::TYPES[60/*int*/], obj));

    if (uIs(obj, ::TYPES[61/*uint*/]))
        return uBox(::g::Uno::Double_typeof(), (double)uUnbox<uint32_t>(::TYPES[61/*uint*/], obj));
...
{
    uObject* so = uAs<uObject*>(obj, ::TYPES[62/*Fuse.Scripting.IScriptObject*/]);

    if ((so != NULL) && (::g::Fuse::Scripting::IScriptObject::ScriptObject(uInterface(uPtr(so), ::TYPES[62/*Fuse.Scripting.IScriptObject*/])) != NULL))
        return ::g::Fuse::Scripting::IScriptObject::ScriptObject(uInterface(uPtr(so), ::TYPES[62/*Fuse.Scripting.IScriptObject*/]));
    ...
    if (so != NULL)
        ::g::Fuse::Scripting::IScriptObject::SetScriptObject(uInterface(uPtr(so), ::TYPES[62/*Fuse.Scripting.IScriptObject*/]), res, context);
