// This file was generated based on C:/Users/Brian/AppData/Local/Fusetools/Packages/Fuse.Scripting/1.6.0/NativeProperty.uno.
...
struct NativeProperty_type : ::g::Fuse::Scripting::NativeMember_type
{
    ...
    void(*fp_SetProperty1)(::g::Fuse::Scripting::NativeProperty*, ::g::Fuse::Scripting::Context*, void*);
};
...
struct NativeProperty : ::g::Fuse::Scripting::NativeMember
{
    ...
    template<class TJSValue>
    void SetProperty1(::g::Fuse::Scripting::Context* context, TJSValue value) { (((NativeProperty_type*)__type)->fp_SetProperty1)(this, context, uConstrain(__type->GetBase(NativeProperty_typeof())->T(1), value)); }
    void SetProperty1_ex(::g::Fuse::Scripting::Context* context, void* value) { (((NativeProperty_type*)__type)->fp_SetProperty1)(this, context, value); }
    template<class T>
    ...
    template<class TJSValue>
    static void SetProperty1(NativeProperty* __this, ::g::Fuse::Scripting::Context* context, TJSValue value) { NativeProperty__SetProperty1_fn(__this, context, uConstrain(__this->__type->GetBase(NativeProperty_typeof())->T(1), value)); }
};
// }
