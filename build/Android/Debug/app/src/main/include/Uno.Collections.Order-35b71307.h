// This file was generated based on C:/Users/Brian/AppData/Local/Fusetools/Packages/Uno.Collections/1.0.1/extensions/$.uno.
...
struct OrderByCompare : uObject
{
    ...
    template<class T>
    int32_t Compare(T a, T b) { int32_t __retval; return OrderByCompare__Compare_fn(this, uConstrain(__type->T(0), a), uConstrain(__type->T(0), b), &__retval), __retval; }
