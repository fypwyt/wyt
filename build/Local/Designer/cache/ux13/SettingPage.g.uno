...
public partial class SettingPage: Fuse.Controls.Page
{
    ...
    void InitializeUX()
    {
        ...
        var temp3 = new global::Fuse.Reactive.Data("goChangePassword");
        var temp4 = new global::Fuse.Reactive.Data("goEditPage");
        ...
        temp_eb29 = new global::Fuse.Reactive.EventBinding(temp2);
        ...
        temp_eb31 = new global::Fuse.Reactive.EventBinding(temp4);
        var temp16 = new global::Fuse.Controls.Button();
        temp_eb32 = new global::Fuse.Reactive.EventBinding(temp5);
        ...
        temp13.Text = "Log Out";
        global::Fuse.Gestures.Clicked.AddHandler(temp13, temp_eb29.OnEvent);
        temp13.Bindings.Add(temp_eb29);
        temp14.Text = "Change Password";
        global::Fuse.Gestures.Clicked.AddHandler(temp14, temp_eb30.OnEvent);
        temp14.Bindings.Add(temp_eb30);
        temp15.Text = "Update profile";
        global::Fuse.Gestures.Clicked.AddHandler(temp15, temp_eb31.OnEvent);
        temp15.Bindings.Add(temp_eb31);
        temp16.Text = "Go Back";
