...
public partial class MainView: Fuse.App
{
    ...
    public partial class Template4: Uno.UX.Template
    {
        [Uno.WeakReference] internal readonly MainView __parent;
        [Uno.WeakReference] internal readonly MainView __parentInstance;
        public Template4(MainView parent, MainView parentInstance): base("changeprofilepage", false)
        {
            __parent = parent;
            __parentInstance = parentInstance;
        }
        ...
        public override object New()
        {
            var __self = new global::ChangeProfilePage(__parent.router);
            __self.Name = __selector0;
            return __self;
        }
        static global::Uno.UX.Selector __selector0 = "changeprofilepage";
    }
    [Uno.Compiler.UxGenerated]
    public partial class Template5: Uno.UX.Template
    {
        [Uno.WeakReference] internal readonly MainView __parent;
        [Uno.WeakReference] internal readonly MainView __parentInstance;
        public Template5(MainView parent, MainView parentInstance): base("changepassword", false)
        {
            __parent = parent;
            __parentInstance = parentInstance;
        }
    ...
    void InitializeUX()
    {
        ...
        var changeprofilepage = new Template4(this, this);
        var changepassword = new Template5(this, this);
        router.Name = __selector0;
        temp17.Children.Add(temp18);
        temp18.DefaultPath = "loginpage";
        temp18.Templates.Add(loginpage);
        temp18.Templates.Add(mainpage);
        temp18.Templates.Add(registerpage);
        temp18.Templates.Add(settingpage);
        temp18.Templates.Add(changeprofilepage);
        temp18.Templates.Add(changepassword);
